                ...
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-12 text-center sm:grid-cols-2 md:grid-cols-3 lg:gap-y-16">
                        <div>
                            ...
                            <h3 className="mt-8 text-lg font-semibold text-black">Website Application</h3>
                        ...
                        <div>
                            ...
                            <h3 className="mt-8 text-lg font-semibold text-black">Cross-Platform App</h3>
                            <p className="mt-4 text-base text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <h3 className="mt-8 text-lg font-semibold text-black">Design UI|UX</h3>
                            <p className="mt-4 text-base text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
                        </div>
                    </div>
                </div>
