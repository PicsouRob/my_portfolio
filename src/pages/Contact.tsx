                    ...
                    <div className="grid grid-cols-1 md:items-stretch md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-10">
                        <div className="flex flex-col justify-between lg:py-5">
                            <div>
                                ...
                                <img className="relative max-w-xs mx-auto -mb-16 md:hidden z-10" src="https://cdn.rareblocks.xyz/collection/celebration/images/contact/4/curve-line-mobile.svg" alt="" />
                        ...
                        <div className="lg:pl-12 my-auto z-40">
